# 🛡️ Kyverno Policy Studio
> Design Kubernetes-native policies. Configure validation rules for security contexts, labels, resource requests, and test pod compliance in real-time.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/kyverno-policy/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/kyverno-policy/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-kyverno-policy.git
cd tp-kyverno-policy
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/kyverno-policy/) |
